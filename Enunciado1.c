...
//Se le summa 2 a los accesos de memoria a la lista doblemente enlazada por la comparacion en el if y por la asignacion a L
...
//Se le suma 3 a los accesos de memoria a la lista doblemente enlazada las asignaciones a L
        }
        else
        {
...
int main()
{
    ...
    do  //Ciclo que se asegura de que el programa no termine hastá que se ingrese el comando necesario
    {
        ...
        {
        printf("Se ingreso mal el comando, ejecute nuevamente.\n");
        Flag=1;
        }
    }while(comando!='F');
    return (0);
